    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex items-center text-sm text-blue-700">
                    ...
                    <span>Analyzing technical accuracy against job requirements...</span>
                  </div>
                  <div className="flex items-center text-sm text-blue-700">
                    <span className="mr-2">📊</span>
                    <span>Evaluating communication and problem-solving skills...</span>
                  </div>
                  <div className="flex items-center text-sm text-blue-700">
                    <span className="mr-2">📑</span>
                    <span>Generating comprehensive performance report for HR...</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Transcript Section (only shown when completed) */}
          {application?.voiceInterviewCompleted && application?.voiceTranscript && (
            <div className="bg-white rounded-xl p-6 mb-8 border border-gray-200 text-left">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                <MessageSquare className="h-5 w-5 mr-2 text-blue-600" />
                Interview Transcript
              </h3>
              <div className="bg-gray-50 rounded-lg p-4 max-h-60 overflow-y-auto text-sm text-gray-700 leading-relaxed font-mono whitespace-pre-line">
                {application.voiceTranscript}
              </div>
              <p className="text-xs text-gray-500 mt-2 italic">
                This is the AI-generated transcript of your conversation.
              </p>
            </div>
          )}
