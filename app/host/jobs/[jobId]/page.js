                        ...
                        <div className="text-right">
                          <div className="flex items-center space-x-4">
                            {application.atsScore && (
                              <div className="text-center bg-purple-50 px-3 py-1 rounded">
                                <p className="text-sm font-bold text-purple-600">{application.atsScore}%</p>
                                <p className="text-xs text-purple-500">Round 1</p>
                              </div>
                            )}
                            {application.voiceInterviewCompleted && (
                              <div className="text-center bg-blue-50 px-3 py-1 rounded">
                                <p className="text-sm font-bold text-blue-600">{application.voiceInterviewScore || 0}%</p>
                                <p className="text-xs text-blue-500">Round 2</p>
                              </div>
                            )}
                            {application.finalScore && (
                              <div className="text-center bg-green-50 px-3 py-1 rounded">
                                <p className="text-sm font-bold text-green-600">{application.finalScore}%</p>
                                <p className="text-xs text-green-500">Final</p>
                              </div>
                            )}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{job.positionsAvailable}</span>
                </div>
              </div>
