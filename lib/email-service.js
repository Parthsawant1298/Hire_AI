        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px; background: white;">
            ...
            <div style="background: #f8f9fa; border-left: 4px solid #007bff; padding: 20px; margin: 20px 0;">
              <h3 style="color: #007bff; margin: 0 0 10px 0;">Selection Details</h3>
              <p style="margin: 5px 0; color: #555;"><strong>Position:</strong> ${job.jobTitle}</p>
              <p style="margin: 5px 0; color: #555;"><strong>Your Ranking:</strong> #${ranking}</p>
              <p style="margin: 5px 0; color: #555;"><strong>Status:</strong> Shortlisted for Voice Interview</p>
            </div>
            
            <p style="color: #555; line-height: 1.6; margin-bottom: 20px;">
              Your resume has been selected by our AI screening system. You are now invited to complete the <strong>Voice Interview</strong> as the next step in the hiring process.
            </p>

            <div style="background: #e8f5e9; border-left: 4px solid #4caf50; padding: 20px; margin: 20px 0;">
              <h3 style="color: #2e7d32; margin: 0 0 10px 0;">🎤 Next Step: Voice Interview</h3>
              <p style="margin: 5px 0; color: #555;">Click the button below to start your voice interview. The interview will be conducted by our AI assistant and should take approximately <strong>${job.voiceInterviewDuration || 15} minutes</strong>.</p>
              <p style="margin: 10px 0 5px 0; color: #555;"><strong>Important:</strong></p>
              <ul style="margin: 5px 0; padding-left: 20px; color: #555;">
                <li>Ensure you have a working microphone and camera</li>
                <li>Find a quiet, well-lit environment</li>
                <li>Complete biometric verification (face + voice) before interview</li>
            ...
            <div style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0;">
              <h4 style="color: #856404; margin: 0 0 10px 0;">🔒 Security Verification Required</h4>
              <p style="margin: 0; color: #856404; font-size: 14px;">Before starting the interview, you'll need to verify your identity using face and voice recognition. This ensures interview integrity and prevents fraud.</p>
            </div>
            
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL || process.env.NEXTAUTH_URL || 'https://hire-ai-sepia.vercel.app'}/verification/pre-interview?jobId=${job._id}&assistant=${job.vapiAssistantId || ''}" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px; display: inline-block;">
            ...
            <div style="background: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; border-radius: 5px; margin: 20px 0;">
              <h4 style="color: #856404; margin: 0 0 10px 0;">⚠️ Next Steps:</h4>
              <ul style="color: #856404; margin: 0; padding-left: 20px;">
                <li>Your profile is under HR review</li>
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px; background: white;">
            ...
            <p style="color: #555; line-height: 1.6; margin-bottom: 20px;">
              Your application is currently under review by our team. We'll notify you once there are any updates.
            </p>
